...
export default function Shop() {
    return (
        <div><div class="container-fluid bg-primary py-5 mb-5 hero-header">
                    ...
                    <div class="col-lg-8 text-center text-lg-start">
                        ...
                        <div class="d-flex align-items-center justify-content-center justify-content-lg-start pt-5">
                            ...
                            <button type="button" class="btn-play" data-bs-toggle="modal"
                                data-src="https://www.youtube.com/embed/uYJQIKAVBw8?si=mTlyn1b8GxFphll6" data-bs-target="#videoModal">
                                <span></span>
                            </button>
                    ...
                    <div class="row gx-5">
                        <div class="col-lg-5 mb-5 mb-lg-0" style="min-height: 500px;">
                            <div class="position-relative h-100">
                                <img class="position-absolute w-100 h-100 rounded" src={about} style="object-fit: cover;" />
                            </div>
                        </div>
                        <div class="col-lg-7">
